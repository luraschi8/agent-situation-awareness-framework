...
SAF is designed for the future of the agentic web, adhering to industry-standard protocols:
- **W3C DIDs:** Uses asymmetric cryptography (Ed25519) for decentralized identity.
- **Agent2Agent (A2A):** Follows the Linux Foundation/Google A2A message envelope patterns.
- **MCP:** Built-in compatibility for Model Context Protocol sharing across trusted nodes.
- **Agent Cards:** Native support for `.well-known/agent-card.json` discovery.
