...
- **Deduplicación Cross-Agent:** Si Michi registra `morning_briefing_sent` para Family Member A a las 08:05, Jarvis lo ve y puede referenciarlo: "Family Member A ya recibió su briefing, ¿quieres que te lo resuma?".
...
- **Protocolo:** La intención del usuario actúa como una llave de paso física. "CompanyX" bloquea Familia y Proyectos, inyectando solo el Dominio Trabajo.
...
- **Tier 2 (Active):** Contexto del mes (Proyecto ProjectAlpha).
